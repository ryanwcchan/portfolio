    ...
    <div className="flex flex-col space-y-4 max-w-6xl mb-10 h-min-screen w-full">
        ...
        <div className="flex flex-col gap-20 md:flex-row justify-center items-center py-6">
            ...
            <div className="flex flex-col justify-center space-y-6 md:w-1/2 md:max-w-[55%] lg:max-w-[60%]">
                ...
                Ever since I was a kid, I have always loved building and creating things. 
                From piecing together my own Lego creations to assembling computers with my dad and creating my first 3D animation with Blender, 
                the thrill of turning ideas into reality has always driven me. This passion naturally evolved as I grew older,
                leading me to find my way in the world of software development.
                </p>
                {/* <p className="w-full my-2 text-md md:text-lg">
